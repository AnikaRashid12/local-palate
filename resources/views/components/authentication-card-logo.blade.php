...
<svg {{ $attributes->merge(['class' => $class]) }} viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Local Palate">
  ...
  <!-- Chopsticks -->
  <path d="M92 20L40 50" stroke="#4b5563" stroke-width="5" stroke-linecap="round"/>
  <path d="M98 24L46 54" stroke="#4b5563" stroke-width="5" stroke-linecap="round"/>
</svg>
